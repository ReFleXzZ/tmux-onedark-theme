...
set "@tmux_mode_indicator_background" "$onedark_cyan"
...
set "@tmux_mode_indicator_prefix_pressed_fg" "$onedark_dark_red"
set "@tmux_mode_indicator_copy_mode_fg" "$onedark_yellow"
set "@tmux_mode_indicator_left_edge_character" ""
set "@tmux_mode_indicator_right_edge_character" ""

status_widgets_right=$(get "@onedark_widgets_right")
status_widgets_left=$(get "@onedark_widgets_left")
time_format=$(get "@onedark_time_format" "%R")
date_format=$(get "@onedark_date_format" "%d/%m/%Y")

set "status-right" "#[fg=$onedark_white,bg=$onedark_black,nounderscore,noitalics]${time_format}  ${date_format} #[fg=$onedark_visual_grey,bg=$onedark_black]#[fg=$onedark_visual_grey,bg=$onedark_visual_grey]#[fg=$onedark_white, bg=$onedark_visual_grey]${status_widgets_right}#{tmux_mode_indicator}#[fg=$onedark_green,bg=$onedark_visual_grey,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_green,bold] #h #[fg=$onedark_yellow, bg=$onedark_green]#[fg=$onedark_red,bg=$onedark_yellow]"
set "status-left" "#[fg=$onedark_visual_grey,bg=$onedark_green,bold] #S #{prefix_highlight} ${status_widgets_left}#[fg=$onedark_green,bg=$onedark_black,nobold,nounderscore,noitalics]"
